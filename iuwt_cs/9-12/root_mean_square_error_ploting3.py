...
image_file0 = fits.open('MSclean_25000ni_256256_thre1mjy_natural_9_13model.fits')
image_file0 = image_file0[0].data[0][0]
# image_file0 = image_file0[0].data[0][0]
# image_file0=np.delete(image_file0,1,axis=0)
print(image_file0.shape)
image_file1 = fits.open('MSclean_25000ni_256256_thre1mjy_natural_9_13image.fits')
# image_file1 = image_file1[0].data
image_file1 = 1*image_file1[0].data[0][0]
# image_file0=np.delete(image_file0,1,axis=0)
